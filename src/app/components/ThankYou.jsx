...
export default function ThankYouSection() {
  ...
  return (
    <section
       ref={ref}
      className={`${playfair.variable} ${caveat.variable} relative min-h-[var(--vh)] px-6 md:px-16 bg-[#2f2f2f] text-[#f4f2ee] transition-all duration-1000 ease-out ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`}
    >
